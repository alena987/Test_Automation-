...
public class TestTwo {
    public static void main(String[] args) {
        ...
        WebElement webElement5 = driver.findElement(By.xpath("//*[@id=\"header\"]/div[1]/nav/div[2]/label/div[1]"));
        webElement5.click();

        WebElement webElement6 = driver.findElement(By.xpath("//*[@id=\"header\"]/div[1]/nav/div[2]/label/div[2]/a[2]"));
        webElement6.click();
